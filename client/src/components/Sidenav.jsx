...
import { FaFileAlt, FaPlusCircle, FaRegLightbulb, FaRegFolderOpen, FaFile, FaFolder, FaEllipsisV, FaUserCircle } from 'react-icons/fa';
  ...
  <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
    ...
    <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
      ...
      <div className="flex flex-row items-center justify-end gap-1">
        ...
        <div
          id="dropdownMenu"
          className="hidden absolute right-2 mt-10 min-w-60 bg-white shadow-md rounded-lg z-50 dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:divide-neutral-700"
          role="menu"
  ...
  dark:bg-neutral-800 dark:border-neutral-700"
      ...
      <div className="lg:ps-[260px] ">
        <div className="min-h-[75rem] p-4 md:p-8">
          ...
          <div id="dashboard" className="min-h-[25rem] scroll-mt-24 p-6">
      ...
      {/* Block 2: Generate an Outline */}
      <div className="flex flex-col items-center p-6 bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl transition-transform transform hover:scale-105 cursor-pointer">
        <FaPlusCircle className="text-primary text-5xl mb-4" />
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Generate an Outline</h3>
      ...
      {/* Block 3: Browse Diagrams */}
      <div className="flex flex-col items-center p-6 bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl transition-transform transform hover:scale-105 cursor-pointer">
        <FaRegLightbulb className="text-primary text-5xl mb-4" />
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Browse Diagrams</h3>
      ...
      {/* Block 4: Open Catalog */}
      <div className="flex flex-col items-center p-6 bg-white border border-t-4 border-t-blue-600 shadow-sm rounded-xl transition-transform transform hover:scale-105 cursor-pointer">
        <FaRegFolderOpen className="text-primary text-5xl mb-4" />
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Open Catalog</h3>
      ...
      <Table />
          ...
          <UserAccount/>
            ...
            <div id="Contact Us" className="min-h-[25rem] scroll-mt-24">
              <Contact/>
            </div>
